...
# ===== Configuration =====
# Data parameters
SIMULATION_BUDGETS = [30000]  # Number of simulations per budget
RUNS_PER_BUDGET = 1          # Number of independent runs per budget
TRAIN_SPLIT = 0.9           # Fraction of data used for training

# Model architecture
HIDDEN_DIM = 256            # Hidden dimension of MLP layers
NUM_TIMESTEPS = 200         # Number of diffusion steps

# Training parameters
BATCH_SIZE = 64             # Batch size for training
NUM_EPOCHS = 1000           # Maximum number of training epochs
LEARNING_RATE = 1e-3        # Initial learning rate
WEIGHT_DECAY = 5*1e-4         # Weight decay for AdamW
